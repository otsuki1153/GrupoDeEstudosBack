...
O projeto **ExpressCRUD** é uma API REST desenvolvida com [Express](https://expressjs.com/) sobre a plataforma [Node.js](https://nodejs.org/), com o objetivo de demonstrar a implementação de um CRUD (*Create, Read, Update, Delete*) de tarefas.
